...
describe('<Accordion />', () => {
  it('renders the <Accordion /> with populated data', () => {
    ...
    expect(getByText('What is TubeFlix?')).toBeTruthy();
    expect(getByText('How much does TubeFlix cost?')).toBeTruthy();
    expect(getByText('Where can I watch?')).toBeTruthy();
    expect(getByText('How do I cancel?')).toBeTruthy();
    expect(getByText('What can I watch on TubeFlix?')).toBeTruthy();
